...
function draw_int_to_chars(score,digits,base_x) -- integer
...
function draw_score(score,gametype,score_p2)
 	local score_text_h=5*8
	local px_text_h=2*8
	if gametype == vs_cpu then
		sspr(0,16,8,score_text_h,
			score_lsd_x,
			sidebar_y+sidebar_h-score_text_h-1)
	else
		sspr(8,16,8,px_text_h,
			score_lsd_x,
			sidebar_y+sidebar_h-score_text_h-1)
		sspr(16,16,8,px_text_h,
			screen_w-8-score_lsd_x,
			sidebar_y+sidebar_h-score_text_h-1)
	end
	draw_int_to_chars(score,score_digits,score_lsd_x)
	if gametype == vs_p2 then
		draw_int_to_chars(score_p2,score_digits,screen_w-8-score_lsd_x)
	end
end
...
sfx_moving_up=26
sfx_full_title=27
function title_sfx(ptime)
	if ptime==title_phase_start_times["hilite"] then
		sfx(sfx_hilite, sfx_ch)
	elseif ptime==title_phase_start_times["rush_in"] then
		sfx(sfx_rush_in, sfx_ch)
	elseif ptime==title_phase_start_times["moving_up"] then
		sfx(sfx_moving_up, sfx_ch)
	elseif ptime==title_phase_start_times["full_title"] then
		sfx(sfx_full_title, sfx_ch)
	end
end
...

...

...

__music__
01 08494b44
00 08494b44
00 08494b44
